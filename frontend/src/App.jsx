...
const resolveApiBase = () => {
  ...
  if (LOCAL_HOSTS.has(window.location.hostname)) {
    ...
    // an explicit configured API base if present. Otherwise use empty string 
    // to utilize the same-origin Vite proxy instead of calling the frontend origin directly.
  ...
  return (
    ...
    >
      ...
      <Card style={{ padding: 24 }}>
        ...
        <GoldScanAnimation active={polling} progress={lastProgressRef.current || 10} domain={domain} scanModel={scanModel} />
        {flashMessage && (
          <div
